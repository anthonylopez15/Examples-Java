...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp1 = new ContaEspecial(800, "111", cliente1, ag1, 1000); // 1a. conta especial
        contaEsp1.saque(900);
        contaEsp1.imprimeDados();
        
        ContaEspecial contaEsp2 = new ContaEspecial(1200, "222", cliente2, ag1, 1500); // 2a. conta especial
        contaEsp2.saque(1600);
        contaEsp2.imprimeDados();
        
        String strData = new java.util.Date().toString();
        ContaPoupanca contaPoup = new ContaPoupanca(700, "333", cliente1, ag1, strData); // conta poupanca
        contaPoup.saque(900);
