package com.capitulo.onze.polimorfismo.laboratorio;
...
public class TesteCastUp {
    ...
    static void imprimirTributavel(Tributavel t) {
    	...
    	if( t instanceof Conta){
    		...
    		System.out.println("Nº Conta: " + c.getNumero());
    		System.out.println("Agencia: " + c.getAgencia().getNumero());
    	}else if(t instanceof Investimento){
    		Investimento i = (Investimento) t;
    		System.out.println("Valor Aplicado: " + i.getValorAplicado());
    	}else{
